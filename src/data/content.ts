...
export const MONSTER_SPECIES: MonsterSpecies[] = [
  { id: 'wolves', name: 'Серые лютоволки', origin: 'natural', habitats: ['forest', 'plains', 'tundra'], threat: 2, behavior: 'охотятся стаями и преследуют слабых', weakness: 'огонь и громкий шум', abilities: ['стайный рывок', 'сбивание с ног'], trophy: 'клык лютоволка', armor: 0, movement: 3 },
  { id: 'trolls', name: 'Речные тролли', origin: 'natural', habitats: ['swamp', 'forest', 'hills'], threat: 5, behavior: 'защищают охотничью территорию', weakness: 'огонь', abilities: ['регенерация', 'тяжёлый удар'], trophy: 'железа регенерации', armor: 2, movement: 1 },
  { id: 'spiders', name: 'Пещерные пауки', origin: 'natural', habitats: ['mountains', 'ancient_forest'], threat: 3, behavior: 'устраивают колонии в тёмных проходах', weakness: 'дым', abilities: ['яд', 'паутина'], trophy: 'ядовитая железа', armor: 1, movement: 3 },
  { id: 'wights', name: 'Клятвенные мертвецы', origin: 'undead', habitats: ['ashlands', 'swamp', 'hills'], threat: 6, behavior: 'охраняют места старых войн', weakness: 'освящённое серебро', abilities: ['ледяное касание', 'аура страха'], trophy: 'осколок клятвенной брони', armor: 3, movement: 2 },
  { id: 'wyverns', name: 'Горные виверны', origin: 'natural', habitats: ['mountains', 'hills'], threat: 7, behavior: 'охотятся возле скал и защищают кладки', weakness: 'сети и тяжёлые арбалеты', abilities: ['ядовитое жало', 'воздушный налёт'], trophy: 'жало виверны', armor: 3, movement: 4 },
  { id: 'glassborn', name: 'Стеклорождённые', origin: 'magical', habitats: ['ashlands', 'desert'], threat: 5, behavior: 'питаются остаточной магией', weakness: 'холод', abilities: ['осколочный взрыв', 'отражение магии'], trophy: 'живой стеклянный кристалл', armor: 4, movement: 2 },
  { id: 'goblins', name: 'Гоблинские налётчики', origin: 'civilized', habitats: ['hills', 'forest', 'mountains'], threat: 3, behavior: 'ставят засады на дорогах и торгуются при перевесе врага', weakness: 'раскол командования', abilities: ['грязная ловушка', 'залп из укрытий'], trophy: 'знак банды', armor: 1, movement: 2 },
  { id: 'constructs', name: 'Древние стражи', origin: 'construct', habitats: ['desert', 'mountains', 'ashlands'], threat: 8, behavior: 'защищают заданные зоны до разрушения', weakness: 'рунические ключи', abilities: ['рунический луч', 'неумолимый марш'], trophy: 'сердечник стража', armor: 5, movement: 1 },
]
